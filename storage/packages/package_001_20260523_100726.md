...
**Source URL:** https://www.postgresql.org/docs/current/planner-optimizer.html

**Extracted:** 2026-05-23T10:07:24.298931
...
If the query uses fewer than [geqo_threshold](https://www.postgresql.org/runtime-config-query.html#GUC-GEQO-THRESHOLD) relations, a near-exhaustive search is conducted to find the best join sequence. The planner preferentially considers joins between any two relations for which there exists a corresponding join clause in the `WHERE`
...
is exceeded, the join sequences considered are determined by heuristics, as described in [Chapter 61](https://www.postgresql.org/geqo.html). Otherwise the process is the same.
...
please use
[this form](https://www.postgresql.org/account/comments/new/18/planner-optimizer.html/)
