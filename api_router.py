...
def training_status():
    ...
    try:
        ...
        if sf.exists():
            out.update(json.loads(sf.read_text(encoding="utf-8")))
            out["phase"] = out.get("phase", "training")
        for name, key in (("expertia-math-puro.jsonl", "dataset_train"), ("expertia-math-puro_val.jsonl", "dataset_val")):
