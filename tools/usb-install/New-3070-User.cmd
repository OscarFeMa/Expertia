...
if errorlevel 1 echo AVISO sshd parado, intentando arrancar & net start sshd >> "%OUT%" 2>&1
echo [2/6] usuario
...
if errorlevel 1 echo FALLO usuario inactivo & set "OK=0" & goto fin
echo [3/6] carpeta
...
if errorlevel 1 echo FALLO autotest local & set "OK=0" & goto fin
echo [6/6] red
